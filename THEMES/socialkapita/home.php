...
<section class="main-banner">
    <div class="container py-5 d-flex flex-column align-items-center justify-content-center align-items-lg-baseline">
        <div class="strip-head mb-3 font-weight-600" data-aos="fade-up">
            <div class="uppercase fs-6">GROW YOUR BUSINESS WITH SOCIAL KAPITA</div>
        </div>
        ...
        <p class="mb-4 fs-5" data-aos="fade-up">At Social Kapita, we empower businesses to thrive and grow by launching
            and<br class="d-none d-lg-block">
            expanding their brands with tailored strategies and expert support.
        </p>
...
?>
            ...
            <div class="col-lg-3 mb-4 mb-lg-0" data-aos="fade-up">
                ...
                <div class="fs-5 text-white font-weight-600 text-body d-flex justify-content-between">
                    ...
                    <a href="<?php echo get_post_meta($post->ID,'Linkedin',true);?>" target="_blank"
